...
ActiveRecord::Schema.define(version: 20160115044432) do
  ...
  add_index "movies_users", ["movie_id"], name: "index_movies_users_on_movie_id"
  add_index "movies_users", ["user_id"], name: "index_movies_users_on_user_id"
